...
2.  **Construct a clean data frame** containing the parsed and converted variables.

3.  **Add a new variable** called `years_worked` that reports the number of full years each employee has worked as of today.

4.  **Return the final cleaned data frame.**
