...
2.  **Add a new variable** called `years_worked` that reports the number of full years each employee has worked as of today.

3.  **Return the final cleaned data frame.**
